...
function smokeStyle(feature){
  ...
  if(v < 5)  return {fillColor:"#2ECC71", weight:0, color:"none", fillOpacity:0.4};
  if(v < 10) return {fillColor:"#F1C40F", weight:0, color:"none", fillOpacity:0.4};
  if(v < 25) return {fillColor:"#E67E22", weight:0, color:"none", fillOpacity:0.4};
  if(v < 50) return {fillColor:"#E74C3C", weight:0, color:"none", fillOpacity:0.4};

  return {fillColor:"#8E44AD", weight:0, color:"none", fillOpacity:0.4};
}
